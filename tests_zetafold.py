...
def test_param_import( verbose = False, use_simple_recursions = False ):
...
def test_known_final_partition(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
...
def test_known_final_partition_with_structure(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_known_final_partition_with_N(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_known_final_partition_dimer(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_known_final_partition_dimer_stack(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_CNGGC_structured(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_CGNCG_tied_MFE(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_num_analytic_deriv(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_enumerate_CNGCNG(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_constrain(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_ext_alphabet_strained_3WJ(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_ext_alphabet(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_fixed_Z_final_bug(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
...
def test_secstruct_bps_parse_motifs(verbose = False, use_simple_recursions = False):
    test_params = get_params_from_file( 'minimal' )
    (C_init, l, l_BP, K_coax, l_coax, C_std, min_loop_length, allow_strained_3WJ ) = test_params.get_variables()
    Kd = test_params.base_pair_types[0].Kd
    C_eff_stacked_pair = test_params.C_eff_stack[ test_params.base_pair_types[0] ][ test_params.base_pair_types[0] ]
