...
for n,line in enumerate(lines):
    ...
    if (line_new.count( 'def' ) == 0 and num_indent >= 4) or len(line_new)==1:
        print 'LINE_STANDARD',line_new, first_char != '#', line_new.count( 'def' ) == 0, first_char != '', num_indent >= 4
        lines_standard.append( ' '*4 + line_new )
    else:
        print 'LINE_NEW',line_new, first_char != '#', line_new.count( 'def' ) == 0, first_char != '', num_indent >= 4
        lines_new.append( line_new )
