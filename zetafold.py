...
if __name__ =='__main__':
    ...
    if args.sequences != None: # run tests
        p = partition( args.sequences, circle = args.circle, params = args.parameters, verbose = args.verbose, mfe = args.mfe, calc_Kd_deriv_DP = args.calc_Kd_deriv_DP, calc_bpp = args.bpp, n_stochastic = int(args.stochastic), do_enumeration = args.enumerate, structure = args.structure, force_base_pairs = args.force_base_pairs, no_coax = args.no_coax, use_simple_recursions = args.simple )
    else:
